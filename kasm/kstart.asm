...
fpu_initstate:
	...
	cdq
	xsave	[rdi]
	mov	[rel globals.initial_fpstate], rdi
...
new_proc:
	...
	lea	rdi, [rbx + proc.xsave]
	mov	ecx, XSAVE_AREA_SIZE / 8
	rep	movsq
